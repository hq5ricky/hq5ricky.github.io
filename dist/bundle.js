...
(() => {
  ...
  function o(e, t) {            //numerical suffix (1K, 1M, 1B, 1T) & scientific notation
    return (
      e || (e = 0),
      e >= 1e15
  ...
  let c, u, p, g, m, b, f, y, x; //refer to line 298 (c,u,p,g,m,b,f,y) x on line 353 (tiling sprite)
  ((e) => {
  ...
  function H(e) {                                 //zombie image on cursor
    ...
    else if (this.dragging) {                     //dragging on map (moving map visual)
  ...
  function L(e) {
    e.preventDefault();
    const t = {
      x: e.clientX * (D.x / document.body.clientWidth),     //adapt to screen width/height
  ...
  const G = {
      ...
      width: 1e3,
      height: 1e3,
      hideParticle(e, t) {        //hide particles
        return (
          e < this.x ||
          t < this.y ||
          e > this.x + this.width ||
  ...
  function U(e, t) {
    !(function (e) {
      ...
      let s = !1;
      const i = c;
      t.w && ((i.y += t.scrollSpeed * e), (s = !0)), //WASD movement around map
  ...
  function O() {        //scale screen to client screen (line 392)
    ...
    (window.onload = function () {
      (v = ne.getInstance()),
        ...
        (function () {
          ...
          const e = new PIXI.Application({ //(local variable)
            width: D.x,
            height: D.y,
          ...
          document.body.appendChild(e.view),
            ...
            e.loader //load sprite json
              ...
              .load(function () {
                (v.app = e),
                  N(),
                  (x = new PIXI.TilingSprite(PIXI.Texture.from("grass.png"))), //grass tiles
  ...
  const Y = { scrollSpeed: 200, w: !1, a: !1, s: !1, d: !1, shift: !1 }; //key vars
  (window.onblur = function () {
    (Y.w = Y.a = Y.s = Y.d = !1), (Y.shift = !1);
  }),
    (window.onkeydown = function (e) { //create key codes on key down (WASD, Shift)
      switch (e.keyCode) {
        case 16:
        case 17:
          Y.shift = !0;
    ...
    (window.onkeyup = function (e) { //create key codes on key up (WASD, Shift)
      switch (e.keyCode) {
        case 16:
        case 17:
          Y.shift = !1;
  ...
  class W { //spell constructor
    constructor(e, t, s, i, a, r, n, o, h, g) {
      (this.id = e),
        (this.name = t),
        (this.tooltip = s),
        (this.itemText = i),
  ...
  class q {
    constructor() {
      if (
        ...
        (this.spells = [ //spell format: {id, name, desc, skeleton desc, cooldown, duration, energy cost, spell start, spell end, base hit activation}
          new W(
            1,
            "Time Warp",
          ...
          new W(
            ...
            0,
            function () {
              new q().humans.pandemic = !0; //pandemic on
            },
            function () {
              new q().humans.pandemic = !1; //pandemic off
            },
            120
          ),
          new W(
            ...
            0,
            function () {
              new se().storm = !0; //part storm on
            },
            function () {
              new se().storm = !1; //part storm off
            },
            90
          ),
        ]),
    ...
    lockAllSpells() {
      for (let e = 0; e < this.spells.length; e++) this.spells[e].unlocked = !1; //all spells locked
    }
    unlockSpell(e) { //unlock spell
      this.spellMap.get(e).unlocked = !0; 
    }
    getSpell(e) { //find spell from dictionary
      return this.spellMap.get(e);
    }
    getUnlockedSpells() { 
      return this.spells.filter((e) => e.unlocked); //gets all unlocked spells
    }
    castSpell(e) { //cast spell (with mana)
      const t = ne.getInstance();
      e.onCooldown ||
        e.active ||
        !e.unlocked ||
        e.energyCost - this.costReduction > t.energy || //cast spell (checks if energy cost > current energy)
        ((t.energy -= e.energyCost - this.costReduction),
        (e.onCooldown = !0), //spell on cooldown
        (e.cooldownLeft = e.cooldown * this.cooldownReduction), //cooldown + cooldown reduction
        (e.active = !0), //spell active
        (e.timer = e.duration + this.timeExtension), //timer + added time
        e.start(),
        t.sendMessage(e.name)); //popup 
    }
    castSpellNoMana(e) {//cast w/o mana (***e = spell id)
    ...
    updateSpells(e) { //updates spell ui (left side)
      for (let t = 0; t < this.spells.length; t++) {
        ...
        s.onCooldown &&
          !s.active &&
          ((s.cooldownLeft -= e), s.cooldownLeft <= 0 && (s.onCooldown = !1)), //time left
          s.active &&
            ((s.timer -= e), s.timer <= 0 && ((s.active = !1), s.end())); //spell ends
      }
    }
  }
  ...
  class ee {
    ...
    roomNoOverlap(e, t) {         //checks if buildings overlap
      return (
        e.x > t.x + t.width + 50 ||
        e.x + e.width + 50 < t.x ||
        e.y > t.y + t.height + 50 ||
    ...
    isValidPosition(e) {                                    //check building pos
    ...
    makeHorizontalWall(e, t, s, i, a, r) {    //build horizontal walls (s = determines entrance)
      if (s) { //if entrance
        const s = this.getWall(t);  //(t = texture)
        (s.x = i),
          (s.y = a),
        ...
        (n.x = i + r / 2 + this.entranceWidth),
          ...
          (n.height = 4),
          e.push(n); //e = wall list
      } else { //if no entrance
        const s = this.getWall(t);
        (s.x = i), (s.y = a), (s.width = r), (s.height = 4), e.push(s);
      }
    }
    makeVerticalWall(e, t, s, i, a, r) {      //build vertical walls (s = determines entrance)
      if (s) { //if entrance
        const s = this.getWall(t);  //(t = texture)
        (s.x = i),
          (s.y = a),
    ...
    getFloorSprite() {
      return this.discardedFloorSprites.length > 0
        ...
        : new PIXI.TilingSprite(PIXI.Texture.WHITE); //white texture for floor sprite
    }
    addBuilding(e) { //vert & horz wall line 833 & 814
      var t, s;
      (e.container = this.getContainer()),
        (e.container.cacheAsBitmap = !1),
        (e.floorSprite = this.getFloorSprite()),
        (e.floorSprite.tint =         //tints ground for floor
        ...
        e.container.addChild(e.floorSprite); //floor (dark area inside buildings)
      const r = [
        {
          x: e.x + e.width / 2,
          y: e.y,
      ...
      let n;
      const o = { x: P.x / 2, y: P.y / 2 }; //map center
      let h = 2e3; //h = 2000
      for (let e = 0; e < r.length; e++) { //r = each side of wall
      ...
      (e.entrance = n),
        this.gameModel.level % 5 == 0 &&
          (e.y < P.y / 2
            ...
            : (e.entrance = r.filter((e) => e.north)[0])),    //decides where entrance should be
        (e.walls = []);
      const l = a(this.buildingTextures, Math.random()); //random building texture
      //* NOTE: e.entrance.__ determines entrance appearance
      this.makeHorizontalWall( //north wall
        e.walls,
        l,
        e.entrance.north,
        -4,
        ...
        this.makeHorizontalWall( //south wall
          e.walls,
          l,
          e.entrance.south,
          -4,
        ...
        this.makeVerticalWall( //west wall
          e.walls,
          l,
          e.entrance.west,
          -4,
        ...
        this.makeVerticalWall( //east wall
          e.walls,
          l,
          e.entrance.east,
          e.width,
  ...
  class oe { //object for stats and data & runes
    constructor() {
      if (
        ((this.gameModel = ne.getInstance()),
        (this.spells = new q()),
        ...
        (this.constructionTypes = { //construction types see line 2929
          graveyard: "graveyard",
          crypt: "crypt",
          fort: "fort",
          fortress: "fortress",
        ...
        //construction list line 2929
        //upgrade list line 3217
        (this.constructionUpgrades = [ //construction format: {id, name, type, cost, build time, ___, ___, max upgrades, construction id req, desc, complete message}
          new he(
            201,
            "Cursed Graveyard",
        ...
        (this.upgrades = [ //upgrade format: {id, name, type (stat increase), cost (resource type), initial cost, % increase per level, stat increase amount, upgrade limit, desc, popup message, construction id unlock}
          new le(
            1,
            "Bloodthirst",
            this.types.damage,
        ...
        (this.prestigeUpgrades = [ //prestige point upgrades {id, name, type, cost type, cost, cost multiplier, upgrade amount, limit, desc, popup message, construction id req}
          new le(
            108,
            "A Small Investment",
        ...
        (this.skillUpgrades = [
          new skill( //test skill tree constructors
            300,
            "Zombie Wolf Upgrade",
            null,
            null,
  ...
  class le { //shop upgrade and prestige constructor
    constructor(e, t, s, i, a, r, n, o, h, l, d) {
      (this.id = e),
        (this.name = t),
        (this.type = s),
  ...
  class skill { //skill tree
    constructor(e, t, s, i, a, r, n, o, h, c, l, d) {
      (this.id = e),
        (this.name = t),
        (this.type = s),
        (this.costType = i),
  ...
  class de { //constructor for trophies?
    constructor() {
      if (
        ((this.gameModel = ne.getInstance()),
  ...
  class Ae {
    ...
    causePlagueExplosion(e, t, s = !0, i = !1) { //make plague explosion
      const a = i ? 75 : 50; //radius toggle (second # is harpy & zombie explosion radius)
  ...
  class Xe {
    ...
    applyItemSpells(e){
      let h = this.spells.getSpell(e).hit - this.hitMods[e]
    ...
    calculateDamage(e) {
      ...
      return (this.model.runeEffects.critChance > 0 &&
        Math.random() < this.model.runeEffects.critChance &&
        ((t *= this.model.runeEffects.critDamage), He(e.x, e.y - 10, t)),t);
    }
    applyItemUpgrades() {
      (this.model = ne.getInstance()),
        (this.moveSpeed = 40),
    ...
    generateLoot(e) {
      ...
      const i = [];
      if (Math.random() < 0.2 * this.lootChanceMod && ((s = this.rarity.rare), Math.random() < 0.2 * this.lootChanceMod && ((s = this.rarity.epic), Math.random() < 0.2 * this.lootChanceMod))) {
  ...
  class Ue { //lists for objects ect
    ...
    updateCreature(e, t) { //creature (golems only) move and attack (ai)
      ...
      switch (
        ((!e.target || e.target.flags.dead) && e.timer.scan < 0 && (e.state = be.lookingForTarget), e.state)
      ) {
        case be.lookingForTarget:
        ...
        function () {
          ...
          return e && e > 0
            ? `Skeleton killing blows reward ${
                10 * e
              }% of your current parts per second`
  ...
  St.forEach((e) => {
    ...
    angular
        ...
        function (e, t, s) {
          ...
          (c.model = ne.getInstance()),
            ...
            (c.resetGame = function () {
              (c.confirmMessage = "Are you sure you want to reset everything? If you have a cloud save it will also be deleted. Make sure you export your save game first."),(c.confirmCallback = function () {c.model.resetData(), (c.confirmCallback = !1);});
            }),
            ...
            (c.cancelConstruction = function () {
              (c.confirmMessage = "Are you sure you want to cancel construction? Used materials will not be refunded"),
                (c.confirmCallback = function () {h.cancelConstruction(), (c.upgrades = h.getAvailableConstructions()), (c.confirmCallback = !1);});
            }),
            ...
            (c.doPrestige = function () {
              (c.confirmMessage = "Are you sure you want to prestige now?"),
                (c.confirmCallback = function () {c.model.prestige(), (c.confirmCallback = !1);});
            }),
            ...
            (c.skeletonMenu = {  //<<<<<<<-------SKELE MENU
              ...
              updateEquippedItems() {//***reset & update equipped data
                this.equipped = [];
                const e = i.persistent.items.filter((e) => e.q && e.s == i.lootPositions.helmet.id);
                e.length > 0 ? this.equipped.push([e[0]]) : this.equipped.push([//helmet (top)
                  {
                    name: "Helmet Slot",
              ...
              itemSubName(e) {
                if (!e.name)
                  switch (e.r) {
                    ...
                    case i.rarity.grand: //new stuff
                      return "Grand level " + e.l + " " + this.itemType(e);
                    case i.rarity.mythic:
                      return "Mythic level " + e.l + " " + this.itemType(e);
                    case i.rarity.divine:
                      return "Divine level " + e.l + " " + this.itemType(e);
                    case i.rarity.sacred:
                      return "Sacred level " + e.l + " " + this.itemType(e);
                  }
                if (-1 == e.s)
              ...
              itemDropped(e, t) { //called when item is "dropped" (item dragged & destination)
                let s = null;
                let wtab = this.wardrobeTab
                i.persistent.items.forEach(function (t) {
                  t.id == e && (s = t);//set s to item object
                }),
                -1 == t ? i.destroyItem(s) : (s.s == t && (i.persistent.items.forEach(function (e) {
                  e.s == t && (e.q = !1, 'w' in e ? e.w.includes(wtab) && (e.w.splice(e.w.indexOf(wtab),1)) : e.w = []); //if selected id (FROM INVENTORY) == destination id, unequips destination id
                }),
                (s.q = !0),
                h.applyUpgrades()),
                this.updateEquippedItems());
              },
              equipItem(e) { //equip item (q value is set to !0) *e is an object **on a click event
                i.persistent.items.forEach(function (t) {
                  t.s == e.s && (t.q = !1); //marked false
                }),
                  (e.q = !0), //marked true
                  ('w' in e ? e.w.push(this.wardrobeTab) : e.w = [this.wardrobeTab]),
                  h.applyUpgrades(),
                  this.updateEquippedItems();
              },
              unequipAll(){
              ...
              trashAll() {
                (c.confirmMessage =
                  "Are you sure you want to destroy all non-equipped items (not including items equipped in the wardrobe)? You will earn " +
                  n(i.xpForItems()) +
                  " xp"),
              ...
              inWardrobe(e, t){ //e = item id, t = wardrobe tab
                i.persistent.items.forEach((q) => {
                  q.s == e.s && (q.s.w)
                })
                
              },
              equipWardrobe(){
                //let e = this.wardrobe.get(this.wardrobeTab)
                let e = null
                ...
                let wtab = this.wardrobeTab
                this.unequipAll()
                console.log("searching at tab >> " + wtab)
                i.persistent.items.forEach((t) => {
                  'w' in t ? (t.w.includes(wtab) && (t.q = !0, console.log("found at: " + e.id))) : t.w = []
                })
                h.applyUpgrades()
                this.updateEquippedItems()
                //const s = i.persistent.items.filter((e) => e.w.includes(1))
                //console.log(s)
              },
              wardrobeRight(){
                this.wardrobeTab < 5 ? this.wardrobeTab++ : this.wardrobeTab = 1;
                this.equipWardrobe()
              },
              wardrobeLeft(){
                this.wardrobeTab > 1 ? this.wardrobeTab-- : this.wardrobeTab = 5;
                this.equipWardrobe()
              },
            }),
            s.ready(function () {
              (e.updatePromise = t(u, 200)), (h.Model = c), kt();
            });
        },
      ])
      ...
      .directive("skillTree", function () { //skill tree
        return { templateUrl: "./templates/skilltree.html" };
      })
      .directive("customOnChange", function () {
        return {
          ...
          link: function (e, t, s) {
            ...
            t.on("change", i),t.on("$destroy", function () {t.off();});
          },
        };
      })
      .directive("draggableItem", ["$rootScope", function (e) {return {restrict: "A", link: function (t, s, i, a) {
              const r = t.item.id;
              "true" == i.draggableItem &&
                ...
                s.bind("dragstart", function (t) {
                  ...
                  t.dataTransfer.setDragImage(s[0], i.width / 2, i.height / 2),e.$emit("item-drag-start", r),
                    setTimeout(function () {angular.element(s)[0].style.opacity = "0.3";});
                }),
      ...
      .directive("droppableTarget", ["$rootScope",function (e) {
          return {restrict: "A", link: function (t, s, i, a) {
            const r = t.item.s; 
            s.bind("dragover", function (e) {
                return (e.preventDefault && e.preventDefault(),(e.dataTransfer.dropEffect = "move"),!1);
              }),
                s.bind("dragenter", function (e) {e.target && e.target.classList && e.target.classList.contains("icon") && angular.element(e.target.parentElement).addClass("over");
                }),
